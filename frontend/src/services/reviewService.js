...
/**
 * Log a customer event (copy/post) to the backend
 */
export async function logCustomerEvent(businessId, eventType) {
  try {
    ...
    console.error("Customer event logging failed:", err);
  }
}
 ...
 */
export async function markReviewPostedAPI(reviewId, text = '') {
  try {
